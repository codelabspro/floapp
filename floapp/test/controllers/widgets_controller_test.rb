...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { category_id: @widget.category_id, description: @widget.description, notes: @widget.notes, title: @widget.title } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { category_id: @widget.category_id, description: @widget.description, notes: @widget.notes, title: @widget.title } }
